...
function GetScreen() {
	...
	$(document).ready(function(){$("#img_btn").val('正在获取，请稍候...'); $.ajax({type: "GET", url: 'website.php?act=screen', data: 'url=' + url, datatype: "script", cache: false, success: function(data){$("body").append(data); $("#img_btn").val('重新获取');}});});	
}
